...
import com.pada.medmaster.application.ports.`in`.ingredient.CreateIngredientUseCase
...
class IngredientController(
    ...
    fun createIngredient(@RequestBody @Parameter(name = "Request body for new Ingredient") createIngredientRequest: CreateIngredientRequest) {
